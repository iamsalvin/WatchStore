...
<!-- Mirrored from htmlstream.com/front-dashboard/account-billing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 04:06:22 GMT -->
<head>
      ...
      <div class="navbar-vertical-footer-offset">
        ...
        <div class="navbar-vertical-content">
          ...
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            <!-- Collapse -->
              <div class="nav-item">
              <a class="nav-link active" href="dashboard-alternative.php" >
        ...
        <div class="col-lg-9">
          <div class="d-grid gap-3 gap-lg-5">
            ...
            <div class="card">
              <!-- Header -->
              <div class="card-header">
                <h4 class="card-header-title">New Orders</h4>
              </div>
              <!-- End Header -->
                ...
                <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                  <thead class="thead-light">
                    <tr>
                      ...
                      <td><a href="user.php?id=<?php echo $res['id'];?>"><b>More</a></td>
													<td><a href="user.php?id=<?php echo $res['id'];?>"><b>Invoice</a></td>
                    </tr>
                  </thead>
...
$data=mysqli_query($con,"select * from invoice where status='new order'");
                    ...
                    ?>
                    <tr>
                      <td><a href="#"><?php echo $res['sno'];?></a></td>
                      <td><span class="badge bg-soft-warning text-warning"><?php echo $res['sdate'];?></span></td>
                      <td><?php echo $res['custmid'];?></td>
                      <td><?php echo $res['name'];?></td>
                      <td><a ></a> <?php echo $res['gtotal'];?></a></td>
                      <td>
                        <a ></a><?php echo $res['sdate'];?></a>
                      </td>
                    </tr>
                     <?php
                            }
  ...
  <!-- Update Plan Modal -->
  <div class="modal fade" id="accountUpdatePlanModal" tabindex="-1" aria-labelledby="accountUpdatePlanModalLabel" role="dialog" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <div class="text-center mb-2 mb-sm-0">
            <a class="btn btn-ghost-secondary" href="#">
              <i class="bi-arrow-left-right me-1"></i> Compare plans
            </a>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <div class="mb-4">
                  ...
                  <input type="password" class="js-input-mask form-control" name="securityCode" id="editCardSecurityCodeLabel" placeholder="xxx" aria-label="xxx" value="789" data-hs-mask-options='{
                          "mask": "000"
                        }'>
                </div>
                <!-- End Form -->
        ...
        <div class="modal-body">
          ...
          <form>
            ...
            <div class="btn-group-sm-vertical">
              <div class="btn-group btn-group-segment btn-group-fill mb-4" role="group" aria-label="Account add card radio button group">
                ...
                <label class="btn btn-sm" for="accountAddCardBtnRadioOption2">PayPal <span class="badge bg-soft-primary text-primary">Coming soon</span></label>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <!-- Form -->
                <div class="mb-4">
                  <label for="securityCodeLabel" class="form-label">CVV Code <i class="bi-question-circle text-body ms-1" data-toggle="tooltip" data-placement="top" title="A 3 - digit number, typically printed on the back of a card."></i></label>
...
<!-- Mirrored from htmlstream.com/front-dashboard/account-billing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 04:06:23 GMT -->
</html>