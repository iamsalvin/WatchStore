...
$sql=mysqli_query($con,"SELECT * FROM newreg WHERE id=$id");
$row=mysqli_fetch_assoc($sql);
$sql2=mysqli_query($con,"SELECT * FROM invoice");
$total=0;
while($tot=mysqli_fetch_assoc($sql2))
{
  $total+=$tot['gtotal'];
}
...
// Query to fetch gtotal for this month
$sql3 = "SELECT SUM(gtotal) AS totalAmount FROM invoice WHERE MONTH(sdate) = '$currentMonth' AND YEAR(sdate) = '$currentYear'";
...
<!-- Mirrored from htmlstream.com/front-dashboard/dashboard-alternative.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 04:04:23 GMT -->
<head>
        ...
        <div class="card-body">
          <div class="row align-items-sm-center mb-4">
            <div class="col-sm mb-3 mb-sm-0">
              <div class="d-flex align-items-center">
                <span class="h1 mb-0"><?php echo $total;?> INR</span>
            ...
            <div class="card-body text-center">
              ...
              <div class="chartjs-doughnut-custom" style="height: 12rem;">
                ...
                <div class="chartjs-doughnut-custom-stat">
                  <small class="text-cap">This months balance</small>
                  <span class="h1"><?php echo $totalAmount; ?></span>
                </div>
              </div>
              <!-- End Chart Half -->
              ...
              <hr>
<?php
$sql4 = mysqli_query($con,"SELECT * FROM invoice ORDER BY sdate DESC LIMIT 1");

$result = mysqli_fetch_assoc($sql4);
?>
              <div class="row col-divider">
                <div class="col text-end">
                  <span class="d-block h4 mb-0"> ₹ <?php echo $result['total']; ?></span>
...
<!-- Mirrored from htmlstream.com/front-dashboard/dashboard-alternative.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 04:04:26 GMT -->
</html>