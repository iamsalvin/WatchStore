...
<!-- Mirrored from htmlstream.com/front-dashboard/ecommerce-customers.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 04:06:39 GMT -->
<head>
              ...
              <div class="nav-item">
                ...
                <div id="navbarVerticalMenuPagesEcommerceMenu" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenuPagesMenu">
                  ...
                  <div id="navbarVerticalMenuPagesMenuEcommerce">
                    ...
                    <!-- Collapse -->
                    <div class="nav-item">
                      <a class="nav-link dropdown-toggle" href="#navbarVerticalMenuPagesEcommerceCustomersMenu" role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuPagesEcommerceCustomersMenu" aria-expanded="true" aria-controls="navbarVerticalMenuPagesEcommerceCustomersMenu">
                        Customers
                      </a>

                      <div id="navbarVerticalMenuPagesEcommerceCustomersMenu" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenuPagesMenuEcommerce">
                        <a class="nav-link active" href="ecommerce-customers.php">Sales Report</a>
          ...
          <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
            ...
            <thead class="thead-light">
              <tr>
                ...
                <th class="table-column-ps-0">Serial No</th>
                <th>Purchase Date</th>
                ...
                <td class="table-column-ps-0">
                  <a class="d-flex align-items-center" href="ecommerce-customer-details.html">
                    ...
                    <div class="flex-grow-1 ms-3">
                      <span class="h5 text-inherit"><?php echo $row['sno']; ?><i class="bi-patch-check-fill text-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Top endorsed"></i></span>
                    </div>
                  </a>
                </td>
...
<!-- Mirrored from htmlstream.com/front-dashboard/ecommerce-customers.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 04:06:40 GMT -->
</html>