...
<head>
 ...
 <?php
  ...
  if (isset($_POST['submit']))
  {
    ...
    move_uploaded_file($_FILES['file']["tmp_name"],"cart/wpbingosite.com/wordpress/wrish/shop/sara-miller-peony/img/".$_FILES['file']["name"]);
	...
	if($n>0)
	{
		echo "<script> alert('Registration Successfull');window.location.href='ecommerce-add-product.php';</script>";
          ...
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-body">
              ...
              <div class="mb-4">
                ...
                <input type="text" class="form-control" name="pn" id="productNameLabel" placeholder="Product Name" aria-label="watches" Required>
              </div>
              <!-- End Form -->
              ...
              <div class="mb-4">
                ...
                <input type="text" class="form-control" name="des" id="productNameLabel" placeholder="Type your description..." aria-label="Shirt, t-shirts, etc." Required>
              </div>
