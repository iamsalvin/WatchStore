...
<!-- Mirrored from htmlstream.com/front-dashboard/ecommerce-orders.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 04:06:38 GMT -->
<head>
                  ...
                  <div id="navbarVerticalMenuPagesMenuEcommerce">
                    ...
                    <div class="nav-item">
                      ...
                      <div id="navbarVerticalMenuPagesEcommerceOrdersMenu" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenuPagesMenuEcommerce">
                        <a class="nav-link active" href="ecommerce-orders.php">Orders</a>
...
$data=mysqli_query($con,"select * from invoice where status='new order'");
              ...
              <tr>
                ...
                <td class="table-column-ps-0">
                  <a href="ecommerce-order-details.php"><?php echo $res['sno'];?></a>
                </td>
                <td><?php echo $res['sdate'];?>(ET)</td>
                <td>
                  <a class="text-body" href="ecommerce-customer-details.html"><?php echo $res['name'];?></a>
                </td>
                <td>
                  <span class="badge bg-soft-success text-success">
                    <span class="legend-indicator bg-success"></span><?php echo $res['status'];?>
                  </span>
                </td>
                <td>
                  <span class="badge bg-soft-info text-info">
                    <span class="legend-indicator bg-info"></span><?php echo $res['shipadd'];?>
                  </span>
                </td>
                <td>
                  <div class="d-flex align-items-center">
                    <img class="avatar avatar-xss avatar-4x3 me-2" src="assets/svg/brands/mastercard.svg" alt="Image Description">
                    <span class="text-dark">&bull;&bull;&bull;&bull; <?php echo $res['cardno'];?></span>
                  </div>
                </td>
                <td>
          <?php echo $res['gtotal'];?>
                ...
                <td><div class="btn-group" role="group">
                    <a class="btn btn-white btn-sm" href="ecommerce-order-details.php?id=<?php echo $res['sno'];?>">
              ...
              <ul class="navbar-nav">
                ...
                <li class="hs-has-sub-menu nav-item">
                  ...
                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="dashboardsMegaMenu" style="min-width: 14rem;">
                    ...
                    <a class="dropdown-item " href="dashboard-alternative.php">Default</a>
                  </div>
                  <!-- End Mega Menu -->
                </li>
                <!-- End Dashboards -->
...
<!-- Mirrored from htmlstream.com/front-dashboard/ecommerce-orders.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 04:06:39 GMT -->
</html>